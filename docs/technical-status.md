...
| 36 | Versioned admin/event APIs and read-access auditing | v0.5 | Durable enterprise integrations and forensic visibility | Designed — audit logs, metrics, notifications, compliance exports, and CLI/admin surfaces already exist; still needs versioned API contracts, event schema versioning, read/view/export audit events, and compatibility guarantees for integrations |
