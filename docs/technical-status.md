...
| `lane start --lane-dir <path> --session-name <name>` | Done | Start a resident interactive lane and create the bounded FIFO bridge |
| `lane send --lane-dir <path> --prompt "<text>"` | Done | Send one prompt through an existing resident lane |
