...
Phase 1 now includes env-based auth preflight because it aligns directly with Guardrail's existing `envPolicy` boundary and the implemented `missing_auth_mapping` contract.
